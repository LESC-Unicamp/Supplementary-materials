...
| Adjustment frequency<br>(volume change) | <code>ADJUSTMENT_FREQUENCY_V</code> | Defines how often volumetric displacement adjustments are performed | Any positive, non-zero <code>INTEGER</code> |
| Maximum translational displacement | <code>MAX_TRANSLATION</code> | Defines the maximum translational displacement (±) in reduced units | Any non-zero <code>FLOAT</code> |
...
| Field orientation | <code>ORIENTATIONAL_FIELD</code> | Defines the unit vector specifying the direction of the external orientational field | A set of three <code>FLOAT</code> numbers<sup>1</sup> |
...
| Name<br> ______________________ | String Name<br> _________________________________ | Definition<br> _______________________________ | Options<br> _________________________________________________ |
|:---:|:---:| --- | --- |
| Probability of movement | <code>PROBABILITY_MOVEMENT</code> | Defines the probability that a movement attempt (translation or rotation) is selected during a trial move | Any positive <code>FLOAT</code> number between 0 and 1 |
