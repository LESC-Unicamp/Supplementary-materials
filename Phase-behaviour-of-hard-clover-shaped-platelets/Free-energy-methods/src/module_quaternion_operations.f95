...
!           This code contains quaternion operation routines used in the main program.            !
!                                                                                                 !
...
!    In a nutshell, it transforms the body-fixed orientation into the space-fixed orientation     !
...
REAL( Kind= Real64 ), DIMENSION( 0:3 ) :: ReferenceUnitQuaternion ! Reference unit quaternion
REAL( Kind= Real64 ), DIMENSION( 0:3 ) :: RandomUnitQuaternion    ! Random quaternion
REAL( Kind= Real64 ), DIMENSION( 0:3 ) :: ComposedUnitQuaternion  ! Composed unit quaternion
