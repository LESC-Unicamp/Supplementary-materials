...
! *********************************************************************************************** !
!                      This function sorts any real array in ascending order                      !
! *********************************************************************************************** !
SUBROUTINE RealArrayAscendingOrder( Array, ArraySize )
...
! INTEGER VARIABLES                                                                               !
! *********************************************************************************************** !
INTEGER( Kind= Int64 ) :: iLoc, jLoc ! Counter (array position)
...
REAL( Kind= Real64 ), DIMENSION( ArraySize ) :: Array   ! Input array

! Sort array in ascending order
DO iLoc = 1, ArraySize - 1
  DO jLoc = 1, ArraySize - iLoc
      IF( Array(jLoc) > Array(jLoc+1) ) THEN
        ! Swap elements
        TempVar       = Array(jLoc)
        Array(jLoc)   = Array(jLoc+1)
        Array(jLoc+1) = TempVar
      END IF
  END DO
END DO

END SUBROUTINE RealArrayAscendingOrder