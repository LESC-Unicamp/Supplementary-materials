MODULE LatticeReductionMethods
...
IF( nDimension == 3 ) THEN
  ! Undo LLL swaps (keeping the swaps may cause inversion of the determinant sign and bad assignments of the box vectors)
...
END MODULE LatticeReductionMethods