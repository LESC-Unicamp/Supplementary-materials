...
<p align="justify">
  This NVT/NPT-Monte Carlo algorithm was designed to evaluate the phase behavior of a system of clover-shaped hard particles (Fig. 1), a nonconvex morphology formed by the union of four identical cylinders. Due to the hard-core interparticle interactions, an algorithm is used to check for overlaps between the cylindrical subparts. Here, we use a combination of the algorithms of <a href="https://doi.org/10.1080/08927020701191349">Ibarra-Avalos <i>et al.</i>, <b>Mol. Simul.</b>, 33, 505-515, 2007</a>, <a href="https://doi.org/10.1140/epje/i2018-11657-0">Orellana <i>et al.</i>, <b>Eur. Phys. J. E</b>, 41, 10, 2018</a>, and <a href="https://doi.org/10.1063/5.0040942">Lopes <i>et al.</i>, <b>J. Chem. Phys.</b>, 154, 104902, 2021</a>.
